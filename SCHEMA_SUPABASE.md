...
CREATE TABLE public.client_documents (
  ...
  CONSTRAINT fk_client_documents_document_type FOREIGN KEY (document_type_id) REFERENCES public.document_types(id),
  CONSTRAINT fk_client_documents_family_member FOREIGN KEY (family_member_id) REFERENCES public.family_members(id)
);
...
CREATE TABLE public.clients (
  ...
  last_request_at timestamp with time zone,
  informations_filled boolean DEFAULT false,
  is_first_visit boolean,
  created_via text,
  is_annual_subscription boolean,
  annual_expiration_date timestamp with time zone,
  isracard_sub_code text,
  isracard_sub_id text,
  subscription_plan text,
  promo_code_expiration_date timestamp with time zone,
  promo_code_reduction integer,
  promo_code_source text,
  phone_verified boolean DEFAULT false,
  phone_verified_at timestamp with time zone,
  verified_phone_number text,
  mirpaa_name text,
  elite_onboarding_done boolean DEFAULT false,
